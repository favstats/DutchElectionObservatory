...
Gegevens uit de Google Ad-bibliotheek zijn waar elke opgegeven advertentie-ID als advertentie wordt geteld. Dit kan het aantal advertenties te hoog zijn, omdat dezelfde advertentie met dezelfde tekst kan worden weergegeven.

## Na verloop van tijd unieke advertenties {.tabset .tabset-fade .tabset-pills}
