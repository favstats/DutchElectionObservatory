...
Voor Facebook-platforms bieden de bestedingsgegevens van de API geen geaggregeerde statistieken per adverteerder. In plaats daarvan biedt het alleen zeer brede grenzen van het uitgegeven geld. Om deze reden zijn de gegevens die hier worden weergegeven afkomstig uit het [Facebook Ad Library Report](https://www.facebook.com/ads/library/report) die wel geld geeft dat door de adverteerder is uitgegeven en die dagelijks wordt opgehaald.
...
Voor Facebook-platforms bieden de bestedingsgegevens van de API geen geaggregeerde statistieken per adverteerder. In plaats daarvan biedt het alleen zeer brede grenzen van het uitgegeven geld. Om deze reden zijn de gegevens die hier worden weergegeven afkomstig uit het [Facebook Ad Library Report](https://www.facebook.com/ads/library/report) die wel geld geeft dat door de adverteerder is uitgegeven en die dagelijks wordt opgehaald. Daarnaast laten de gegevens ook de uitgaven per regio zien.
...
## Na verloop van tijd {.tabset .tabset-fade .tabset-pills}
...
Voor Facebook-platforms bieden de bestedingsgegevens van de API geen geaggregeerde statistieken per adverteerder. In plaats daarvan biedt het alleen zeer brede grenzen van het uitgegeven geld. Om deze reden zijn de gegevens die hier worden weergegeven afkomstig uit het [Facebook Ad Library Report](https://www.facebook.com/ads/library/report) die wel geld geeft dat door de adverteerder is uitgegeven en die dagelijks wordt opgehaald. Een voorbehoud is echter dat als een eigendom onder de 100 euro per dag wordt uitgegeven, het exacte bedrag niet wordt weergegeven. Om deze reden tonen we betrouwbaarheidsintervallen rond het bedrag.
