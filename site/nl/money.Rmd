  ...
  filter(date_range_start == max(date_range_start))  %>% 
      hchart(
        ...
        hcaes(
          ...
          y = cum_spent,
          color = color),
        tooltip = list(pointFormat = "<b>Totaal bedrag uitgegeven aan Facebookadvertenties:</b> €{point.cum_spent:,.0f}")) %>%
...
gg_spending_time <- fb_aggr$report_spending %>% 
  ...
  labs(y = "Totaal bedrag uitgegeven aan Facebookadvertenties", x = "Date")
